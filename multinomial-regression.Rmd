...
#Reshape for mlogit()
peak_moddf <- peak_moddf[,c(1:2, 14:22)]
mdata <- mlogit.data(peak_moddf, varying = NULL, choice = "HistoMaturity", shape = "wide")

# Run a model!
test_mod <- mlogit(HistoMaturity ~ 1 | peak1.m + peak2.m + peak3.m + peak4.m + peak6.m + peak7.m + peak9.m + GSI.m + length.m, data = mdata, reflevel = "IMM")

test_mod2 <- multinom(HistoMaturity ~ peak1.m + peak2.m + peak3.m + peak4.m + peak6.m + peak9.m + GSI.m + length.m, data = peak_moddf)
